...
ScenePathFinding3::ScenePathFinding3()
{
	draw_grid = false;
...
void ScenePathFinding3::update(float dtime, SDL_Event *event)
{
...
void ScenePathFinding3::drawCoin()
{
...
void ScenePathFinding3::initMaze()
{
...
bool ScenePathFinding3::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D ScenePathFinding3::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D ScenePathFinding3::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x/CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool ScenePathFinding3::isValidCell(Vector2D cell)
{
